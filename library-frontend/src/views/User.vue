                ...
                <v-container>
                    <v-row>
                        <v-col cols="12" sm="6" md="4">
                            <v-autocomplete v-model="selectedBook" class="mt-1 pt-4" color="blue darken-1" :items="booksLocal" label="Book" dense item-text="titulo" return-object="true"></v-autocomplete>
                        </v-col>
                        <v-col cols="12" sm="6" md="4">
                            <v-autocomplete v-model="selectedPartner" class="mt-1 pt-4" color="blue darken-1" :items="partnersLocal" label="Partner" dense item-text="nombre" return-object="true"></v-autocomplete>
                        </v-col>
                        <v-col cols="12" sm="6" md="4">
                            ...
                            <v-menu v-if="editedIndex >= 0" ref="menu" v-model="menu" :close-on-content-click="false" :return-value.sync="date" transition="scale-transition" offset-y min-width="290px">
                                <template v-slot:activator="{ on }">
                                    <v-text-field v-model="date" label="Due date" prepend-icon="" readonly v-on="on"></v-text-field>
                                </template>
